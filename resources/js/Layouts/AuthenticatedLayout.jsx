...
const NAV = [
    ...
    { name: 'Patients', route: 'patients.index', icon: Users, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
    { name: 'Checkups', route: 'checkups.index', icon: HeartPulse, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
    { name: 'Appointments', route: 'appointments.index', icon: CalendarDays, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
    { name: 'Nurse Notes', route: 'nurse-notes.index', icon: ClipboardPlus, roles: ['admin', 'doctor', 'nurse'] },
    { name: 'Medical Records', route: 'medical-records.index', icon: Activity, roles: ['admin', 'doctor', 'nurse'] },
    { name: 'Lab Orders', route: 'lab-orders.index', icon: FlaskConical, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
    { name: 'Billing', route: 'bills.index', icon: Banknote, roles: ['admin', 'doctor', 'receptionist'] },
    { name: 'Admissions', route: 'admissions.index', icon: BedDouble, roles: ['admin', 'doctor', 'nurse', 'receptionist'] },
    ...
    { name: 'Nurses', route: 'nurses.index', icon: HeartPulse, roles: ['admin'] },
